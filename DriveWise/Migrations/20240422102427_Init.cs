        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CO2EmissionKm = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndDateId = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rentals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Rentals_Collaborators_CollaboratorId",
                        column: x => x.CollaboratorId,
                        principalTable: "Collaborators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarpoolsAsPassengerId = table.Column<int>(type: "int", nullable: false),
                    PassengersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarpoolCollaborator", x => new { x.CarpoolsAsPassengerId, x.PassengersId });
                    table.ForeignKey(
                        name: "FK_CarpoolCollaborator_Carpools_CarpoolsAsPassengerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarpoolCollaborator_PassengersId",
                table: "CarpoolCollaborator",
                column: "PassengersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_CollaboratorId",
                table: "Rentals",
                column: "CollaboratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_EndDateId",
                table: "Rentals",
                column: "EndDateId");

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_StartDateId",
                table: "Rentals",
                column: "StartDateId");
